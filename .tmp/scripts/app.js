...
function getRefs() {
    preFunc();
    instance.list_refrences(function (error, result) {
        console.log(result);
        document.getElementById("ref1").innerHTML = result[0]['c'][0];
        document.getElementById("ref2").innerHTML = result[1]['c'][0];
        document.getElementById("ref3").innerHTML = result[2]['c'][0];
        document.getElementById("ref4").innerHTML = result[3]['c'][0];
    });
}
